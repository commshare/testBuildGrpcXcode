...
void grpc_resolver_dns_ares_init() {
  ...
  if (should_use_ares(resolver.get())) {
    ...
    gpr_log(GPR_DEBUG, "===grpc_resolver_dns_ares_init=====Using ares dns resolver=====");
    ...
    gpr_log(GPR_DEBUG,
            "===grpc_resolver_dns_ares_init=====NOT USE =====");
...
void grpc_resolver_dns_ares_shutdown() {
  if (g_use_ares_dns_resolver) {
    gpr_log(GPR_DEBUG,
            "===grpc_resolver_dns_ares_shutdown=====Using ares dns resolver=====");
